# Team Jerseys & Spirit Wear: A Coach's Guide to Ordering Without the Headache

Every season, coaches and team parents inherit the same thankless job: getting everyone a jersey, on time, in the right size, without blowing the budget. Here's how to make it painless.

## Start three weeks before you need them
...
## Spirit wear: the easy fundraiser hiding in plain sight

Parents, grandparents, and siblings *want* gear with the team name on it. A simple spirit-wear add-on — tees, hoodies, maybe a cap — sold at a few dollars over cost can fund your end-of-season party or next year's equipment. Take pre-orders with your size form so you print exactly what's sold: zero leftover inventory, zero risk.

## What we need from you

Just three things:

1. Your logo or mascot art (or a description — we can help design one)
2. Your roster with sizes and numbers
3. Your deadline

We'll send a free digital proof before anything gets printed, so what shows up in the box is exactly what you approved. [Request a team quote](#quote) and let's get your season sorted.
