...
(function () {
  ...
  var css = [
    ...
    '.szb a{color:#ff0100;text-decoration:none}',
    '.szb a:hover{text-decoration:underline}',
    '.szb-head{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;margin-bottom:24px;border-bottom:3px solid #ff0100;padding-bottom:14px}',
    '.szb-head h2{margin:0;display:flex;align-items:center;gap:14px;font-family:"Archivo Black",arial,sans-serif;font-size:1.6rem;font-weight:400;text-transform:uppercase;letter-spacing:.01em;color:#fff}',
    '.szb-head h2 .szb-zone{color:#ff0100}',
    '.szb-logo{height:52px;width:auto;display:block}',
    '.szb-head p{margin:0;color:#919191;font-size:.88rem}',
    '.szb-badge{display:inline-block;background:#ff0100;color:#fff;font-size:.68rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;padding:4px 12px;margin-bottom:12px}',
    ...
    '.szb-feat:hover{border-color:#ff0100;box-shadow:0 10px 30px rgba(0,0,0,.5)}',
    ...
    '.szb-card:hover{border-color:#ff0100;box-shadow:0 8px 24px rgba(0,0,0,.5)}',
    ...
    '.szb-more{font-size:.78rem;font-weight:700;color:#ff0100;text-transform:uppercase;letter-spacing:.08em}',
    '.szb-article{background:#161616;border:1px solid #2e2e2e;padding:34px;max-width:780px;margin:0 auto}',
    '.szb-back{display:inline-flex;align-items:center;gap:6px;background:none;border:1px solid #ff0100;padding:8px 18px;font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#ff0100;cursor:pointer;margin-bottom:22px;font-family:Montserrat,arial,sans-serif}',
    '.szb-back:hover{background:#ff0100;color:#fff}',
    '.szb-article h1{font-family:"Archivo Black",arial,sans-serif;font-size:1.55rem;font-weight:400;text-transform:uppercase;line-height:1.3;color:#fff;margin:0 0 10px}',
    '.szb-article h2{font-family:"Archivo Black",arial,sans-serif;font-size:1.05rem;font-weight:400;text-transform:uppercase;color:#ff0100;margin:28px 0 10px}',
    ...
    '.szb-article th{background:#ff0100;color:#fff;text-align:left;padding:8px 12px;font-weight:700;text-transform:uppercase;font-size:.78rem;letter-spacing:.05em}',
    '.szb-article td{border:1px solid #2e2e2e;padding:8px 12px;color:#c2c2c2}',
    '.szb-article tr:nth-child(even) td{background:#1b1b1b}',
    '.szb-cta{background:#ff0100;padding:4px 18px;margin-top:24px}',
    '.szb-cta,.szb-article p.szb-cta{color:#fff}',
    '.szb-cta strong{color:#fff}',
    '.szb-cta a{color:#fff;font-weight:700;text-decoration:underline}',
  ...
  function init(root) {
    ...
    function renderList(posts) {
      ...
      head.appendChild(el('h2', null,
        '<img class="szb-logo" src="' + BASE + 'assets/logo.png" alt="ShirtZone logo">' +
        '<span class="szb-title">The Shirt<span class="szb-zone">Zone</span> Blog</span>'));
